...
class AttentionLOGOConvFCBBoxHead(AttentionLogoBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(AttentionLOGOConvFCBBoxHead, self).__init__(*args, **kwargs)
    ...
    def init_weights(self):
        super(AttentionLOGOConvFCBBoxHead, self).init_weights()
    ...
    def forward(self, x, support_feature):
        ...
        if self.head_config[0]:
            ...
            for i, sf in enumerate(support_feature):
                ...
                x_ge = torch.cat([x_global_relation, sf], dim = 1)
...
@HEADS.register_module()
class AttentionSharedLOGO2FCBBoxHead(AttentionLOGOConvFCBBoxHead):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(AttentionSharedLOGO2FCBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
