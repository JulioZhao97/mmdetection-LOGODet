...
data = dict(
    ...
    train=dict(
        ...
        ann_file=
        '/data/zhaozhiyuan/tb_variation/VOCdevkit_all/VOC2007/ImageSets/Main/split1/trainval3.txt',
    ...
    val=dict(
        type='VOCDataset_split1',
        ann_file=
        '/data/zhaozhiyuan/tb_variation/VOCdevkit_all/VOC2007/ImageSets/Main/split1/test_across_style3.txt',
        img_prefix='/data/zhaozhiyuan/tb_variation/VOCdevkit_all/VOC2007/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/zhaozhiyuan/mmdetection_checkpoints/4_23/logo_faster_rcnn_r50_fpn_1x_coco_base_3classes_normal_init'
gpu_ids = range(0, 1)