...
data = dict(
    ...
    val=dict(
        type='VOCDataset_3',
        ann_file='/data/zhaozhiyuan/tb_variation/VOCdevkit_all/VOC2007/ImageSets/Main/test_across_style_sample3.txt',
        img_prefix='/data/zhaozhiyuan/tb_variation/VOCdevkit_all/VOC2007/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(
        type='VOCDataset_3',
        ann_file='/data/zhaozhiyuan/tb_variation/VOCdevkit_all/VOC2007/ImageSets/Main/test_across_style_sample_100.txt',
        img_prefix='/data/zhaozhiyuan/tb_variation/VOCdevkit_all/VOC2007/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/zhaozhiyuan/mmdetection_checkpoints/logo_faster_rcnn_r50_fpn_1x_coco_attention_detector_3classes_pr'
gpu_ids = range(0, 1)
